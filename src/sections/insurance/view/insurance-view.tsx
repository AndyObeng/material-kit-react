...
import { InsuranceTableHead } from '../insurance-table-head';
import { TableEmptyRows } from '../table-empty-rows';
import { InsuranceTableToolbar } from '../insurance-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../utils';

import type { InsuranceProps } from '../insurance-table-row';
...
try {   
   ...
   axios.defaults.headers.common['Authorization'] = `Bearer ${api_token}`;
       ...
       const URL = "https://api.cropestate.com/api/userinsurance";
...
.then(async result => {
  ...
  const dataFiltered: InsuranceProps[] = applyFilter({
