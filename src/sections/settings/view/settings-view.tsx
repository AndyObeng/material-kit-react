...
import { SettingsTableHead } from '../settings-table-head';
import { TableEmptyRows } from '../table-empty-rows';
import { SettingsTableToolbar } from '../settings-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../utils';

import type { SettingsProps } from '../settings-table-row';
...
try {   
    ...
    axios.defaults.headers.common['Authorization'] = `Bearer ${api_token}`;
       ...
       const URL = "https://api.cropestate.com/api/appsettings";
...
.then(async result => {
  ...
  const dataFiltered: SettingsProps[] = applyFilter({
